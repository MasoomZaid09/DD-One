...
class FormComponent(
    ...
    private val _formResponse = MutableStateFlow<StateClass.UiState<FormResponse>>(StateClass.UiState.Idle)
    var formResponse = _formResponse

    private val _singleDeviceResponse = MutableStateFlow<StateClass.UiState<SingleDeviceResponse>>(StateClass.UiState.Idle)
